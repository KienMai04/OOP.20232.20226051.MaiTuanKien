...
public class Equations {
    ...
    public static void first_degree_equation() {
        ...
        strNum1 = JOptionPane.showInputDialog(null, "Input a: ", "Input the a",
    ...
    public static void solveSystem() {
        ...
        strNum1 = JOptionPane.showInputDialog(null, "Input a1: ", "Input a1",
                JOptionPane.INFORMATION_MESSAGE);
        strNum2 = JOptionPane.showInputDialog(null, "Input b1: ", "Input b1",
                JOptionPane.INFORMATION_MESSAGE);
        strNum3 = JOptionPane.showInputDialog(null, "Input a2: ", "Input a2",
                JOptionPane.INFORMATION_MESSAGE);
        strNum4 = JOptionPane.showInputDialog(null, "Input b2: ", "Input b2",
                JOptionPane.INFORMATION_MESSAGE);
        ...
        if (determinant == 0) {
            JOptionPane.showMessageDialog(null, "He phuong trinh khong co nghiem");
        } else {
